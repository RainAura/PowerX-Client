...
public class EventRenderEntity implements Event {
	...
	public void fire(EntityLivingBase entity, boolean pre, float limbSwing, float limbSwingAmount, float ageInTicks,
			float rotationYawHead, float rotationPitch, float chestRot, float offset) {
		this.entity = entity;
		this.pre = pre;
