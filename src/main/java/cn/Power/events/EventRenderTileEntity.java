...
public class EventRenderTileEntity implements Event {
	...
	public EventRenderTileEntity(TileEntityRendererDispatcher tileEntityRendererDispatcher, TileEntity tileentityIn,
			float partialTicks, int destroyStage, double staticPlayerX, double staticPlayerY, double staticPlayerZ) {
