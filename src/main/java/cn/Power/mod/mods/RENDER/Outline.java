...
public class Outline
{
    ...
    public Outline update() {
        ...
        final int var9 = Math.max(Minecraft.getDebugFPS(), 30);
        GL11.glClear(16640);
        Minecraft.getMinecraft().entityRenderer.updateFogColor((float)(Minecraft.getMinecraft().entityRenderer.renderEndNanoTime + 1000000000 / var9));
        ...
        if (Outline.shaderProgramID == -1) {
            ...
            try {
                if (Outline.vertexShaderID == -1) {
                    ...
                    Outline.vertexShaderID = RenderHelper.createShader("#version 120 \nvoid main() { \ngl_TexCoord[0] = gl_MultiTexCoord0; \ngl_Position = gl_ModelViewProjectionMatrix * gl_Vertex; \n}", 35633);
                }
