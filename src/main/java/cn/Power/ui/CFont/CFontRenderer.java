...
public class CFontRenderer extends CFont {
	...
	public float drawStringWithShadow1(String text, double x, double y, int color) {
	...
	public float drawString1(String text, double x, double y, int color) {
		float shadowWidth = this.drawString(text, x, y, color, false);
		return Math.max(shadowWidth, this.drawString(text, x, y, color, false));
	}
