...
public class AltLoginThread extends Thread {
    ...
    private static TheAlteningAuthentication accountAuth = new TheAlteningAuthentication(AlteningServiceType.MOJANG);
	...
	public AltLoginThread(String username, String password) {
		...
		if(this.password.contains("<TheAltening>"))
			this.status = "\u00a7eTheAltening......";
		else
