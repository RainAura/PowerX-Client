...
public class GuiAltLogin extends GuiScreen {
	...
	public void drawScreen(int x, int y, float z) {
		...
		if (this.username.getText().isEmpty()) {
			Helper.mc.fontRendererObj.drawStringWithShadow("Username / E-Mail / TheAltening token", this.width / 2 - 96, 66.0f, -7829368);
		}
		
		if(this.username.getText().contains("-") && !this.username.getText().contains("@")) {
			this.password.setText("<TheAltening>");
			Helper.mc.fontRendererObj.drawStringWithShadow("# TheAltening", this.width / 2 - 96, 106.0f, -829368);
		}
		
		if (this.password.getText().isEmpty()) {
			Helper.mc.fontRendererObj.drawStringWithShadow("Password / empty (TheAltening)", this.width / 2 - 96, 106.0f, -7829368);
		}
		if (this.combined.getText().isEmpty()) {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(1, this.width / 2 - 100, var3 + 72 + 12 + 24, "Import user:pass"));
		this.buttonList.add(new GuiButton(2, this.width / 2 - 100, var3 + 72 + 12 + 24 + 24, "Back"));
