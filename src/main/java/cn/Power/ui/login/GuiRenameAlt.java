...
public class GuiRenameAlt extends GuiScreen {
	...
	public void actionPerformed(GuiButton button) {
		...
		case 1: {
			...
			if (data.contains(":")) {
				...
				this.nameField.setText(credentials[0]);
				this.pwField.setText(credentials[1]);
			}
			break;
		}
		case 0: {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(1, this.width / 2 - 100, this.height / 4 + 116 + 12, "Import user:pass"));
		this.buttonList.add(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 140 + 12, "Cancel"));
