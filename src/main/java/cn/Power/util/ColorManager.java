...
public class ColorManager {
	...
	public static ColorObject getEnemyTeam() {
		return fTeam;
	}

	public static ColorObject getEnemyAntibot() {
		return Antibot;
	}

	public static ColorObject esp = new ColorObject(0, 70, 255, 100);
	...
	public static ColorObject Antibot = new ColorObject(0, 0, 255, 255);
	public static ColorObject chamsVis = new ColorObject(255, 0, 0, 255);
	public static ColorObject chamsInvis = new ColorObject(0, 255, 0, 255);
