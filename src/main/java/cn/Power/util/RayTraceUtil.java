	...
	public EntityLivingBase getEntity() {
		...
		for (Object o : this.mc.theWorld.loadedEntityList) {
			...
			if (!(o instanceof EntityLivingBase)
					|| (double) this.mc.thePlayer.getDistanceToEntity(e = (EntityLivingBase) o) >= dist
					|| this.mc.thePlayer == e)
				continue;
			for (Vector3f vec : this.getPositions()) {
				if (!this.isInBox(vec, e)
						|| this.mc.thePlayer.getDistanceToEntity(e) >= this.mc.thePlayer.getDistanceToEntity(entity))
					continue;
				entity = e;
			}
		}
