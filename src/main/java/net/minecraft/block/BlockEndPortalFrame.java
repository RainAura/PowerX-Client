...
public class BlockEndPortalFrame extends Block {
	...
	public BlockEndPortalFrame() {
		...
		this.setDefaultState(
				this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(EYE, false));
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		return this.getDefaultState().withProperty(EYE, (meta & 4) != 0).withProperty(FACING,
