...
public class BlockRailPowered extends BlockRailBase {
	...
	protected BlockRailPowered() {
		...
		this.setDefaultState(this.blockState.getBaseState()
				.withProperty(SHAPE, BlockRailBase.EnumRailDirection.NORTH_SOUTH).withProperty(POWERED, false));
	}
	...
	protected boolean func_176566_a(World worldIn, BlockPos pos, IBlockState state, boolean p_176566_4_,
		...
		if (p_176566_5_ >= 8) {
			...
			if (this.func_176567_a(worldIn, new BlockPos(i, j, k), p_176566_4_, p_176566_5_,
					blockrailbase$enumraildirection)) {
				return true;
			} else {
				return flag && this.func_176567_a(worldIn, new BlockPos(i, j - 1, k), p_176566_4_, p_176566_5_,
						blockrailbase$enumraildirection);
			}
		}
	}
			...
			if (p_176567_5_ != BlockRailBase.EnumRailDirection.EAST_WEST
				...
				if (p_176567_5_ != BlockRailBase.EnumRailDirection.NORTH_SOUTH
					...
					if (iblockstate.getValue(POWERED)) {
						return worldIn.isBlockPowered(p_176567_2_) ? true
								: this.func_176566_a(worldIn, p_176567_2_, iblockstate, p_176567_3_, distance + 1);
					} else {
						return false;
					}
				} else {
