...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		ChatUtil.printChat("Death Position :   x: " + Math.round(mc.thePlayer.posX) + "    y:" + Math.round(mc.thePlayer.posY) + "    z:" + Math.round(mc.thePlayer.posZ));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj,
				"Death Position :   x: " + Math.round(mc.thePlayer.posX) + "    y:" + Math.round(mc.thePlayer.posY) + "    z:" + Math.round(mc.thePlayer.posZ),
				this.width / 2, 26, 16777215);
