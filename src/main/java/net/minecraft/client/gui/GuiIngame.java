...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
		...
		EventRender2D E2 = new EventRender2D();
    ...
    //        this.renderHorseJumpBar(scaledresolution, k1);
		...
		if (Client.instance.getNotificationManager() != null
				&& Client.instance.getNotificationManager().getNotifications() != null)
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks)
    {
        ...
        {
			Hud hud = (Hud) ModManager.getModByClass(Hud.class);
			
		if (hud.isEnabled() && hud.hotbar.getValueState().booleanValue()) {
			RenderUtil.drawRect(sr.getScaledWidth() / 2 - 91, sr.getScaledHeight() - 23, sr.getScaledWidth() / 2 + 91,
					sr.getScaledHeight(), Integer.MIN_VALUE);
	//		RenderUtil.drawRect(sr.getScaledWidth() / 2 - 91, sr.getScaledHeight() - 23, sr.getScaledWidth() / 2 + 91,
	//				sr.getScaledHeight() - 22, RenderUtil.rainbow(100)/* , RenderUtil.rainbow(5000) */);
			if (mc.thePlayer.inventory.currentItem == 0) {
				RenderUtil.drawRect(sr.getScaledWidth() / 2 - 91, sr.getScaledHeight() - 22,
    ...
    {
				if (ModManager.getModByClass(Crosshair.class).isEnabled()) {
			return false;
		}
...
//    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
//    {
//			if (Client.score.getValueState().booleanValue())
//			return;
//
//
//        Scoreboard scoreboard = objective.getScoreboard();
...
//
//
//       ScoreBoard sb = (ScoreBoard) ModManager.getModByClass(ScoreBoard.class);
//
//
//		int i1 = collection.size() * this.getFontRenderer().FONT_HEIGHT;
//		int j1 = sb.isEnabled() ? sb.Y.getValueState().intValue() : scaledRes.getScaledHeight() / 2 + i1 / 3;
//
//		int k1 = sb.isEnabled() ? sb.X.getValueState().intValue() : 3;
//		int l1 =  scaledRes.getScaledWidth() - i - k1;
//		int j = 0;
//
//
