	...
	public void drawChat(int updateCounter) {
		if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
			...
			if (k > 0) {
				...
				int ss = Client.ChatBackGround.getValueState().intValue();//(int) ((float) 255 * f);

				if (h > 0 && ss != 0)
					RenderUtil.rectangleBordered(-1, -h * 9 - 1, l + 8, -h * 9 + h * 9 + 1, -0.5, ss / 2 << 24,
							Colors2.getColor(153, 153, 153, 40));
...
//                                drawRect(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
							...
							this.mc.fontRendererObj.drawStringWithShadow(s, (float) i2, (float) (j2 - 8), 16777215);
