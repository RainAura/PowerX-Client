...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, s, 2, this.height - 10, 8421504);
        String s2 = "Minecraft 1.8.9";
        int i = this.fontRendererObj.getStringWidth(s2);
        this.drawCenteredString(this.fontRendererObj, s2, this.width - i - 2, this.height - 10, 8421504);
