...
public class MapItemRenderer {
	...
	class Instance {
		...
		private void render(boolean noOverlayRendering) {
			...
			worldrenderer.pos((double) ((float) (i + 0) + f), (double) ((float) (j + 128) - f), (double) -0.01F)
					.tex(0.0D, 1.0D).endVertex();
			worldrenderer.pos((double) ((float) (i + 128) - f), (double) ((float) (j + 128) - f), (double) -0.01F)
					.tex(1.0D, 1.0D).endVertex();
			worldrenderer.pos((double) ((float) (i + 128) - f), (double) ((float) (j + 0) + f), (double) -0.01F)
					.tex(1.0D, 0.0D).endVertex();
			worldrenderer.pos((double) ((float) (i + 0) + f), (double) ((float) (j + 0) + f), (double) -0.01F)
