...
//        }
		...
		this.buttonList
				.add(new GuiButton(1, this.width / 2 - 155, this.height - 24 - 6, 150, 20, I18n.format("gui.done")));
...
//        }
	...
	class ServerList extends GuiSlot {
		...
		protected void elementClicked(int slotIndex, boolean isDoubleClick, int mouseX, int mouseY) {
			// this.mc.gameSettings.streamPreferredServer =
			// this.mc.getTwitchStream().func_152925_v()[slotIndex].serverUrl;
			this.mc.gameSettings.saveOptions();
		}
		...
		protected boolean isSelected(int slotIndex) {
			return false;
			// return
			// this.mc.getTwitchStream().func_152925_v()[slotIndex].serverUrl.equals(this.mc.gameSettings.streamPreferredServer);
		}
