...
public class GuiStreamOptions extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList
				.add(new GuiButton(200, this.width / 2 - 155, this.height / 6 + 168, 150, 20, I18n.format("gui.done")));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.field_152315_t) {
			this.drawCenteredString(this.fontRendererObj,
					EnumChatFormatting.RED + I18n.format("options.stream.changes"), this.width / 2,
