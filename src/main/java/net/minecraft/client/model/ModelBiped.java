...
public class ModelBiped extends ModelBase {
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		if (entityIn.equals(Minecraft.getMinecraft().thePlayer) && ModManager.getModByClass(Dab.class).isEnabled()  && Minecraft.getMinecraft().gameSettings.thirdPersonView > 0) {
