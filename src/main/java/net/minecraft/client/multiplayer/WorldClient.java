...
public class WorldClient extends World
{
    ...
    private final WeakHashSet<Entity> entityList = new WeakHashSet<Entity>();
    ...
    public WorldClient(NetHandlerPlayClient netHandler, WorldSettings settings, int dimension, EnumDifficulty difficulty, Profiler profilerIn)
    {
        ...
        if (this.mc.playerController != null && this.mc.playerController instanceof PlayerControllerMP)
        {
    ...
    public boolean invalidateRegionAndSetBlock(BlockPos pos, IBlockState state)
    {
        ...
        if(Helper.xray &&
        		Xray.Que.contains(pos))
        	Xray.toRender.add(pos);
        
  		if(mc.theWorld.getBlockState(pos).getBlock().getLocalizedName() ==new String("Sugar cane")) {
			System.err.println(mc.theWorld.getBlockState(pos).getBlock().getLocalizedName());
