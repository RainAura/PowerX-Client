...
public class BlockModelShapes
{
    ...
    public TextureAtlasSprite getTexture(final IBlockState state) {
        final Block lvt_2_1_ = state.getBlock();
        IBakedModel lvt_3_1_ = this.getModelForState(state);
        if (lvt_3_1_ == null || lvt_3_1_ == this.modelManager.getMissingModel()) {
            if (lvt_2_1_ == Blocks.wall_sign || lvt_2_1_ == Blocks.standing_sign || lvt_2_1_ == Blocks.chest || lvt_2_1_ == Blocks.trapped_chest || lvt_2_1_ == Blocks.standing_banner || lvt_2_1_ == Blocks.wall_banner) {
                return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/planks_oak");
            }
            if (lvt_2_1_ == Blocks.ender_chest) {
                return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/obsidian");
            }
            if (lvt_2_1_ == Blocks.flowing_lava || lvt_2_1_ == Blocks.lava) {
                return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/lava_still");
            }
            if (lvt_2_1_ == Blocks.flowing_water || lvt_2_1_ == Blocks.water) {
                return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/water_still");
            }
            if (lvt_2_1_ == Blocks.skull) {
                return this.modelManager.getTextureMap().getAtlasSprite("minecraft:blocks/soul_sand");
            }
            if (lvt_2_1_ == Blocks.barrier) {
        ...
        return lvt_3_1_.getParticleTexture();
    }
    
    public IBakedModel getModelForState(final IBlockState state) {
        IBakedModel lvt_2_1_ = this.bakedModelStore.get(state);
        if (lvt_2_1_ == null) {
            lvt_2_1_ = this.modelManager.getMissingModel();
        }
        return lvt_2_1_;
    }
    ...
    public void reloadModels() {
        ...
        for (final Map.Entry<IBlockState, ModelResourceLocation> lvt_2_1_ : this.blockStateMapper.putAllStateModelLocations().entrySet()) {
            this.bakedModelStore.put(lvt_2_1_.getKey(), this.modelManager.getModel(lvt_2_1_.getValue()));
        }
    }
    ...
    private void registerAllBlocks() {
        ...
        this.registerBlockWithStateMapper(Blocks.quartz_block, new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(final IBlockState state) {
                final BlockQuartz.EnumType lvt_2_1_ = state.getValue(BlockQuartz.VARIANT);
                switch (lvt_2_1_.ordinal()) {
                    default: {
        ...
        this.registerBlockWithStateMapper(Blocks.pumpkin_stem, new StateMapperBase() {
            @Override
            protected ModelResourceLocation getModelResourceLocation(final IBlockState state) {
                final Map<IProperty, Comparable> lvt_2_1_ = (Map<IProperty, Comparable>)Maps.newLinkedHashMap((Map)state.getProperties());
                if (state.getValue(BlockStem.FACING) != EnumFacing.UP) {
                    lvt_2_1_.remove(BlockStem.AGE);
                }
                return new ModelResourceLocation(Block.blockRegistry.getNameForObject(state.getBlock()), this.getPropertyString(lvt_2_1_));
            }
        });
        ...
        this.registerBlockWithStateMapper(Blocks.dirt, new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(final IBlockState state) {
                final Map<IProperty, Comparable> lvt_2_1_ = (Map<IProperty, Comparable>)Maps.newLinkedHashMap((Map)state.getProperties());
                final String lvt_3_1_ = BlockDirt.VARIANT.getName((BlockDirt.DirtType)lvt_2_1_.remove(BlockDirt.VARIANT));
                if (BlockDirt.DirtType.PODZOL != state.getValue(BlockDirt.VARIANT)) {
                    lvt_2_1_.remove(BlockDirt.SNOWY);
                }
        ...
        this.registerBlockWithStateMapper(Blocks.double_stone_slab, new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(final IBlockState state) {
                final Map<IProperty, Comparable> lvt_2_1_ = (Map<IProperty, Comparable>)Maps.newLinkedHashMap((Map)state.getProperties());
                final String lvt_3_1_ = BlockStoneSlab.VARIANT.getName((BlockStoneSlab.EnumType)lvt_2_1_.remove(BlockStoneSlab.VARIANT));
                lvt_2_1_.remove(BlockStoneSlab.SEAMLESS);
                final String lvt_4_1_ = state.getValue((IProperty<Boolean>)BlockStoneSlab.SEAMLESS) ? "all" : "normal";
        ...
        this.registerBlockWithStateMapper(Blocks.double_stone_slab2, new StateMapperBase() {
            ...
            protected ModelResourceLocation getModelResourceLocation(final IBlockState state) {
                final Map<IProperty, Comparable> lvt_2_1_ = (Map<IProperty, Comparable>)Maps.newLinkedHashMap((Map)state.getProperties());
                final String lvt_3_1_ = BlockStoneSlabNew.VARIANT.getName((BlockStoneSlabNew.EnumType)lvt_2_1_.remove(BlockStoneSlabNew.VARIANT));
                lvt_2_1_.remove(BlockStoneSlab.SEAMLESS);
                final String lvt_4_1_ = state.getValue((IProperty<Boolean>)BlockStoneSlabNew.SEAMLESS) ? "all" : "normal";
                return new ModelResourceLocation(lvt_3_1_ + "_double_slab", lvt_4_1_);
            }
        });
    }
