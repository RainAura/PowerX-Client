...
public class FaceBakery
{
    ...
    private void storeVertexData(final int[] faceData, final int storeIndex, final int vertexIndex, final Vector3f position, final int shadeColor, final TextureAtlasSprite sprite, final BlockFaceUV faceUV) {
        ...
        faceData[i + 4] = Float.floatToRawIntBits(sprite.getInterpolatedU(faceUV.func_178348_a(vertexIndex) * 0.999 + faceUV.func_178348_a((vertexIndex + 2) % 4) * 0.001));
        faceData[i + 4 + 1] = Float.floatToRawIntBits(sprite.getInterpolatedV(faceUV.func_178346_b(vertexIndex) * 0.999 + faceUV.func_178346_b((vertexIndex + 2) % 4) * 0.001));
    }
    ...
    private void applyFacing(final int[] p_178408_1_, final EnumFacing p_178408_2_) {
        ...
        for (int i2 = 0; i2 < 4; ++i2) {
            final int j2 = step * i2;
            final EnumFaceDirection.VertexInformation enumfacedirection$vertexinformation = enumfacedirection.getVertexInformation(i2);
    ...
    private void lockVertexUv(final int p_178401_1_, final int[] p_178401_2_, final EnumFacing facing, final BlockFaceUV p_178401_4_, final TextureAtlasSprite p_178401_5_) {
        ...
        final int j = p_178401_4_.func_178345_c(p_178401_1_) * step;
