...
import cn.Power.util.ClientPhysic;
...
//				GlStateManager.rotate((-Minecraft.thePlayer.rotationYaw % 360.0f), (-Minecraft.thePlayer.rotationPitch % 180.0f), 1.0F, 0.0F);
				 GL11.glRotatef(-Minecraft.getMinecraft().getRenderManager().playerViewY, 0.0F, 1.0F, 0.0F);
		         GL11.glRotatef(Minecraft.getMinecraft().gameSettings.thirdPersonView == 2 ? -Minecraft.getMinecraft().getRenderManager().playerViewX : Minecraft.getMinecraft().getRenderManager().playerViewX, 1.0F, 0.0F, 0.0F);
			}
	...
	public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
		if (ModManager.getModByClass(ItemPhysic.class).isEnabled()) {
