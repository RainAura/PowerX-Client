...
//			final EntityPlayer entityplayer = Minecraft.getMinecraft().theWorld.getPlayerEntityByUUID(uuid);
			...
			if (entitylivingbaseIn instanceof EntityPlayer && ((ModelBiped) this.livingEntityRenderer.getMainModel()).heldItemRight == 3) {
...
//	@Override
//	public void doRenderLayeritem(EntityLivingBase entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
//			float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
//		   ItemStack itemstack = entitylivingbaseIn.getHeldItem();
//
//	        if (itemstack != null)
