...
{
    public Map<Class<? extends TileEntity>, TileEntitySpecialRenderer<? extends TileEntity>> mapSpecialRenderers;
    ...
    public <T extends TileEntity> TileEntitySpecialRenderer<T> getSpecialRenderer(final TileEntity tileEntityIn) {
        return (tileEntityIn == null || tileEntityIn.isInvalid()) ? null : this.getSpecialRendererByClass(tileEntityIn.getClass());
    }
