...
public class GameSettings
{
    ...
    public KeyBinding keyBindClientCommand = new KeyBinding("key.clientcommand", 12, "key.categories.misc");
    ...
    {
        this.keyBindings = ArrayUtils.addAll((KeyBinding[])(new KeyBinding[] {this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, this.keyBindStreamCommercials, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines}), (KeyBinding[])this.keyBindsHotbar);
    ...
    public void setOptionValue(GameSettings.Options settingsOption, int value)
    {
		...
		if (settingsOption == GameSettings.Options.BG_ENABLED) {
                ...
                if (this.optionsFile.exists())
                {
                    ...
                    while ((s = bufferedreader.readLine()) != null)
                    {
                        try
                        {
                        	...
                        	if (astring[0].equals("bgEnabled")) {
								this.bgEnabled = astring[1].equals("true");
							}
    ...
    public void saveOptions()
    {
        ...
        try
        {
            ...
            printwriter.println("bgEnabled:" + this.bgEnabled);
