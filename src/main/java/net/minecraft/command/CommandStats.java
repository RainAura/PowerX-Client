		...
		if (args.length < 1) {
			...
			if (commandresultstats$type == null) {
				...
				if (flag) {
					...
					if (tileentity == null) {
						throw new CommandException("commands.stats.noCompatibleBlock", blockpos.getX(), blockpos.getY(),
								blockpos.getZ());
					}
					...
					if (tileentity instanceof TileEntityCommandBlock) {
						...
						if (!(tileentity instanceof TileEntitySign)) {
							throw new CommandException("commands.stats.noCompatibleBlock", blockpos.getX(),
