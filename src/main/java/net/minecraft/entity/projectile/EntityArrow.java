...
public class EntityArrow extends Entity implements IProjectile {
	...
	public void setThrowableHeading(double x, double y, double z, float velocity, float inaccuracy) {
		...
		y = y / (double) f;
		z = z / (double) f;
		x = x + this.rand.nextGaussian() * (double) (this.rand.nextBoolean() ? -1 : 1) * (double) 0.0075F
				* (double) inaccuracy;
		y = y + this.rand.nextGaussian() * (double) (this.rand.nextBoolean() ? -1 : 1) * (double) 0.0075F
				* (double) inaccuracy;
		z = z + this.rand.nextGaussian() * (double) (this.rand.nextBoolean() ? -1 : 1) * (double) 0.0075F
				* (double) inaccuracy;
		x = x * (double) velocity;
		y = y * (double) velocity;
		z = z * (double) velocity;
		...
		this.prevRotationPitch = this.rotationPitch = (float) (MathHelper.atan2(y, (double) f1) * 180.0D
	...
	public void setVelocity(double x, double y, double z) {
		...
		if (this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F) {
			...
			this.prevRotationYaw = this.rotationYaw = (float) (MathHelper.atan2(x, z) * 180.0D
					/ (double) (float) Math.PI);
			this.prevRotationPitch = this.rotationPitch = (float) (MathHelper.atan2(y, (double) f) * 180.0D
					/ (double) (float) Math.PI);
	...
	public void onUpdate() {
		...
		if (this.inGround) {
							...
							if (this.knockbackStrength > 0) {
								...
								if (f7 > 0.0F) {
									movingobjectposition.entityHit.addVelocity(
											this.motionX * (double) this.knockbackStrength * (double) 0.6F
													/ (double) f7,
											0.1D, this.motionZ * (double) this.knockbackStrength * (double) 0.6F
													/ (double) f7);
								}
							}
			...
			this.rotationYaw = (float) (MathHelper.atan2(this.motionX, this.motionZ) * 180.0D
					/ (double) (float) Math.PI);
