...
public abstract class EntityFireball extends Entity {
	...
	public void onUpdate() {
		if (this.worldObj.isRemote || (this.shootingEntity == null || !this.shootingEntity.isDead)
			...
			this.rotationYaw = (float) (MathHelper.atan2(this.motionZ, this.motionX) * 180.0D
					/ (double) (float) Math.PI) + 90.0F;

			for (this.rotationPitch = (float) (MathHelper.atan2((double) f1, this.motionY) * 180.0D
