						...
						if (this.ticksCatchableDelay <= 0) {
							...
							if (block1 == Blocks.water || block1 == Blocks.flowing_water) {
								if (this.rand.nextFloat() < 0.15F) {
									worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, d13, d15 - (double) 0.1F,
											d16, 1, (double) f10, 0.1D, (double) f11, 0.0D);
								}

								float f3 = f10 * 0.04F;
								float f4 = f11 * 0.04F;
								worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, (double) f4,
										0.01D, (double) (-f3), 1.0D);
								worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0,
										(double) (-f4), 0.01D, (double) f3, 1.0D);
							}
						}
						...
						if (this.rand.nextFloat() < f1) {
							...
							if (block == Blocks.water || block == Blocks.flowing_water) {
								worldserver.spawnParticle(EnumParticleTypes.WATER_SPLASH, d12, d14, d6,
										2 + this.rand.nextInt(2), (double) 0.1F, 0.0D, (double) 0.1F, 0.0D);
							}
						}
