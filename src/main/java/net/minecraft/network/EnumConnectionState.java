...
import net.minecraft.network.play.client.C20PacketVehicleMove;
...
public enum EnumConnectionState {
	...
	PLAY(0) {
		{
			...
			this.registerPacket(EnumPacketDirection.SERVERBOUND, C20PacketVehicleMove.class);
		}
	},
	STATUS(1) {
		{
	...
	private final Map<EnumPacketDirection, BiMap<Integer, Class<? extends Packet>>> directionMaps = Maps
			.newEnumMap(EnumPacketDirection.class);
