...
public class ChatStyle {
	...
	public ChatStyle Clickto(ClickEvent event) {
		if (chatClickEvent == null) {
			Minecraft.getMinecraft().thePlayer.sendChatMessage(event.toString());
		}
	...
	public boolean equals(Object p_equals_1_) {
		if (this == p_equals_1_) {
			...
			if (this.getBold() == chatstyle.getBold() && this.getColor() == chatstyle.getColor()
					&& this.getItalic() == chatstyle.getItalic() && this.getObfuscated() == chatstyle.getObfuscated()
