...
public class WorldGenSwamp extends WorldGenAbstractTree {
	...
	private static final IBlockState field_181649_b = Blocks.leaves.getDefaultState()
			.withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.OAK).withProperty(BlockOldLeaf.CHECK_DECAY, false);
	...
	private void func_181647_a(World p_181647_1_, BlockPos p_181647_2_, PropertyBool p_181647_3_) {
		...
		for (BlockPos blockpos = p_181647_2_.down(); p_181647_1_.getBlockState(blockpos).getBlock()
