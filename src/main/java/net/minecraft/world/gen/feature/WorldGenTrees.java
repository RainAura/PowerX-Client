...
public class WorldGenTrees extends WorldGenAbstractTree {
	...
	private void func_181652_a(World p_181652_1_, int p_181652_2_, BlockPos p_181652_3_, EnumFacing p_181652_4_) {
		this.setBlockAndNotifyAdequately(p_181652_1_, p_181652_3_, Blocks.cocoa.getDefaultState()
				.withProperty(BlockCocoa.AGE, p_181652_2_).withProperty(BlockCocoa.FACING, p_181652_4_));
	}
	...
	private void func_181651_a(World p_181651_1_, BlockPos p_181651_2_, PropertyBool p_181651_3_) {
		this.setBlockAndNotifyAdequately(p_181651_1_, p_181651_2_,
				Blocks.vine.getDefaultState().withProperty(p_181651_3_, true));
	}
	...
	private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
		...
		for (BlockPos blockpos = p_181650_2_.down(); p_181650_1_.getBlockState(blockpos).getBlock()
