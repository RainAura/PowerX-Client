...
public class ModelAdapterBat extends ModelAdapter
{
    ...
    public ModelRenderer getModelRenderer(ModelBase model, String modelPart)
    {
        ...
        else
        {
            ...
            {
                return (ModelRenderer)modelbat.batHead;
            }
            else if (modelPart.equals("body"))
            {
                return (ModelRenderer)modelbat.batBody;
            }
            else if (modelPart.equals("right_wing"))
            {
                return (ModelRenderer)modelbat.batRightWing;
            }
            else if (modelPart.equals("left_wing"))
            {
                return (ModelRenderer)modelbat.batLeftWing;
            }
            else if (modelPart.equals("outer_right_wing"))
            {
                return (ModelRenderer)modelbat.batOuterRightWing;
            }
            else
            {
