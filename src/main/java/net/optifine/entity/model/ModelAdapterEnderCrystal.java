	...
	public ModelRenderer getModelRenderer(ModelBase model, String modelPart) {
		if (!(model instanceof ModelEnderCrystal)) {
			...
			if (modelPart.equals("cube")) {
				return (ModelRenderer) modelendercrystal.cube;
			} else if (modelPart.equals("glass")) {
				return (ModelRenderer) modelendercrystal.glass;
			} else {
				return modelPart.equals("base") ? (ModelRenderer) modelendercrystal.base : null;
			}
		}
	}
